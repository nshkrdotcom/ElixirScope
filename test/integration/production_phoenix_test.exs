if Code.ensure_loaded?(Phoenix.ConnTest) and Code.ensure_loaded?(Phoenix.LiveViewTest) do
  ...
  # Phoenix not available - skip Phoenix production integration tests
  defmodule ElixirScope.Integration.ProductionPhoenixTest do
    use ExUnit.Case

    @moduletag :integration

    test "Phoenix production integration tests skipped - Phoenix not available" do
      # This test will show up but indicate why Phoenix production tests are skipped
      assert true, "Phoenix production integration tests skipped because Phoenix.ConnTest or Phoenix.LiveViewTest is not available"
    end
  end
end
